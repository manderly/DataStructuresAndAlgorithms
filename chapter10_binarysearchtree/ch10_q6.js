...
var words = ["quack","quack","woof","meow","quack",
              ...
              "meow","whimper","growl","lol"]; //8 uniques, woof is the most common
...
console.log("There are " + wordsBST.countNodes() + " nodes in this binary search tree.");

//2. Add a function to the BST class that counts the number of edges in a BST.
console.log("There are " + wordsBST.countEdges() + " edges in this binary search tree.");
